...
Si quisieras hacer combinaciones como "un plato vegano dificil", basta con agregarle un guion y la primer letra de la dificultad [f, m o d], ejemplo:
#vegano-d (plato vegano dificil)
y si buscas recetas libre de gluten añade '-tacc' al final, #vegano-d-tacc`;
...
Los ingredientes son: ${recetaRandom.ingredients}
